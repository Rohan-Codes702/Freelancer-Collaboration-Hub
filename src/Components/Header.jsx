...
function Header({ darkMode, setDarkMode, sidebarOpen, setSidebarOpen }) {
  return (
    <header className="relative flex justify-between items-center p-4 md:p-6 bg-gradient-to-r from-slate-800 via-slate-700 to-slate-800 border-b border-slate-600/50 shadow-2xl backdrop-blur-sm overflow-hidden">
      {/* Animated Background */}
      ...
      <div className="relative z-10 flex items-center gap-4">
        ...
        <button
          ...
          className="md:hidden p-2 rounded-lg bg-slate-700 hover:bg-slate-600 transition-colors duration-300"
        ...
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent tracking-wide">
